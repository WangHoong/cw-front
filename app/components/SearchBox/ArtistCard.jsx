      ...
      <li
        ...
        <div className='info'>
          ...
          <div className='txt'>
            ...
            {/* 为ADMIN显示ID和公司 */}
            <Role component='span' roleName='ADMIN' style={{position: 'absolute', fontSize: '16px', color: 'red', bottom: '-12px', left: '5px', zIndex: '10', fontWeight: 'bold'}}>{this.props.data.id + '---' + this.props.data.company.name}</Role>
          </div>
        </div>
