/**
 * Created by chenyanhong on 15/5/4.
 */
// var SongList = React.createClass({
//   render:function(){
//     var maxNum,minWidth,maxWidth;
//     minWidth=150;
//     maxWidth=400;
...
//         maxNum=comment.num;
//       }
//       bglWidth=(comment.num/maxNum*maxWidth).toFixed(0);
//       var _style={
//         width:bglWidth
//       }
//       if(comment.rank<=3){
...
//               <span className="tps-rank-top"><b>{comment.rank}</b></span>
//               <span className="tps-bgl-top" style={_style}>
//               <span className="tps-song"><b><a href={comment.link}>{comment.name}-</a></b></span>
//               <a href={comment.link2}><span>{comment.singer}</span></a>
//               </span>
//               <span className="tps-num">{comment.num}</span>
//
//             </p>
//         )
//       }else{
//         return(
//           <p className="tps-member">
//               <span className="tps-rank-other"><b>{comment.rank}</b></span>
//               <span className="tps-bgl-other" style={_style}>
//               <span className="tps-song"><b><a href={comment.link}>{comment.name}-</a></b></span>
//               <a href={comment.link2}><span>{comment.singer}</span></a>
//               </span>
//               <span className="tps-num">{comment.num}</span>
...
//     };
//     return(
//       <div className="tps-body">{this.props.items.map(createItem)}</div>
//     )
//   }
//
// });
