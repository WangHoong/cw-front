...
module.exports = {
  ...
  pro: function() {
    ...
    router.get('/', function *() {
      ...
      if (!body.data.online) {
        return this.redirect('/home' + '?' + this.querystring);
      }
    ...
    router.get('/signin', function* () {
      var isGlobal = /global\.topdmc\.com|lo\.topdmc\.cn:9000/.test(this.request.header.host)
      if (isGlobal) {
    ...
    router.get('/contactus', function *() {
      this.body = yield render('contactus', {
        version: version,
        lang: require(__dirname +'/../i18n/' + this.__language).home
      });
    });
